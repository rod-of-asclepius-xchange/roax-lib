...
Specification, schemas, the conformance corpus, and the independent Python implementation under `python/`.
...
and do not import them from one. If you need a further implementation for cross-checking, add
another single-file one.
