...
**One further question was identified after those rulings and is open: D14** - whether the type-map lookup matches over an NFC-normalized key or over the bytes as received.
It belongs to nobody in particular and is in `docs/decisions.md` part 2a.
