...
The Rust library under [`rust/`](../rust) and the Python library under [`python/`](../python) are the two of them that live in this repository; the ruling also covers a TypeScript implementation, which does not.
